    ...
    rows.forEach(row => {
        ...
        statusButton.addEventListener('click', () => {
            ...
            if (currentState === 'pending') {
                ...
                // Check for text and create report row if it exists
                ...
                // Always set placeholder for completed state
                ...
                // First remove read-only attribute
                textarea.removeAttribute('readonly');
                
                // Then clear placeholder after confirming textarea is editable
                if (!textarea.hasAttribute('readonly')) {
                    textarea.placeholder = '';
                }
            }
            
            // Update status button and star
            if (newState) {
                ...
                star.className = `star ${newState}`;
                star.setAttribute('data-state', newState);
            }
        });
